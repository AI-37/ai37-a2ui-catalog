...
/**
 * Предлагаемая шкала: три кегля 26 / 14 / 12 и одна гарнитура.
 *
...
export const TYPE_PROPOSAL: ProposedTypeStep[] = [
  ...
  {
    token: '--a2ui-text-sub',
    metrics: '12/1.3 · 400, подпись — 500',
    role: 'подтекст: подпись поля, вторичный текст, ссылка, чип, заметка, подпись секции',
    sample: {fontFamily: SANS, fontSize: 12, lineHeight: 1.3},
...
/**
 * Чем платим за 26/14/12. Ни один пункт не является возражением — это то, что
...
export const SCALE_COSTS: Array<[string, string]> = [
  ...
  [
    'подтекст мельчает на 0.5px',
    '36 объявлений 12.5px едут на 12px: подписи полей, ссылки, строки слоёв',
  ],
  [
    'кнопка растёт с 13 на 14px',
    'вместе с абзацами и таблицами; промежуточной ступени 13px в шкале 26/14/12 нет',
  ],
  [
