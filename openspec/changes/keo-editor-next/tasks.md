...
- [x] 8.4 Перезапустить дев-серверы: Next держит старый бандл в `.next`
...
- [x] 9.1 Экран в настоящем чате на живом агенте, не в витрине
- [x] 9.2 Проверить реальную ширину сообщения, тему хоста, чужие стили
- [x] 9.3 Проверить поведение агента на ответном снапшоте: следствие условия возвращается
- [x] 9.4 Правки по кругу до явного «принято» владельца
