 ...
 * (или пустой блок, если агент его не прислал). `condition` берётся из
 * `general`, а при пустом значении — из устаревшего top-level пропа
 * (Решение 6 design.md); `null` дальше означает λБ, как на сервере.
 */
export function createGeneralState(
  ...
  return {
    buildingType: general?.buildingType ?? null,
