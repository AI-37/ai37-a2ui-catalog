 ...
 * `Rпр = r · (1/αв + 1/αн + Σ (thicknessMm/1000)/λ)`, где r — коэффициент
 * теплотехнической однородности карточки (Г.4), без него 1. Канонический
 * расчёт — на сервере; здесь мгновенная обратная связь по мере правок.
 * Спец-кейсы:
 *
