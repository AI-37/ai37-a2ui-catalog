/**
 * Двухчастная пилюля «label value» блока «Исходные данные». `Chip` набора
 ...
 *
 * Модификаторы объявлены двумя классами: у `.a2ui-chip` свои отступы, и при
 * равной специфичности победил бы порядок слоёв набора.
 */
export const KIT_DATA_CHIP_CSS = `
