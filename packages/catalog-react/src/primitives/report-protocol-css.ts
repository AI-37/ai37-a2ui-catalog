/**
 * Строка протокола: лейбл (он же кнопка-раскрывашка, когда под строкой есть
 * содержимое), мета и действие в правом краю. Геометрия у обоих состояний
 * одна — появление шеврона не должно двигать строку.
 */
